...
enum SBDNotificationPriority : NSInteger;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull parentMessageText SWIFT_UNAVAILABLE_MSG("This property has been removed.");
...
@property (nonatomic, readonly, strong) SBDMessageMetaArray * _Nullable metaArray SWIFT_UNAVAILABLE_MSG("Use `metaArrays` instead.");
...
/// <ul>
///   <li>
///     It does <em>not</em> contain all properties of the parent message.
///   </li>
///   <li>
///     Only contains:
///     <ul>
///       <li>
///         common: <code>customType</code>, <code>message</code>, <code>timestamp</code>, <code>sender</code>, <code>data</code>
///       </li>
///       <li>
///         FileMessage: <code>url</code>, <code>plainURL</code>, <code>name</code>, <code>size</code>, <code>type</code>, <code>thumbnails</code>
///       </li>
///     </ul>
///   </li>
/// </ul>
...
/// since:
/// 4.11.0
@property (nonatomic, strong) SBDNotificationData * _Nullable notifiationData;
/// since:
/// 4.13.0
...
/// since:
/// 4.14.0
@property (nonatomic, readonly, strong) SBDFeedback * _Nullable myFeedback;
/// since:
/// 4.14.0
@property (nonatomic, readonly) enum FeedbackStatus myFeedbackStatus;
/// This field is intended to store temporary in-memory data, such as UI interaction configurations.
/// note:
/// This field is not locally cached and data is not restored, so it is not suitable for storing data for long periods of time.
/// warning:
/// Even if the message ID is the same, the value of this property will be different if the reference of the message object is different.
/// since:
/// 4.15.0
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable inMemoryUserInfo;
/// Priority for notification.
/// This is valid in the notification message. The default value is <code>normal</code>.
/// since:
/// 4.16.0
@property (nonatomic) enum SBDNotificationPriority notificationPriority;
...
/// returns:
/// <code>true</code> if when this is a group channel.
- (BOOL)isFeedChannel SWIFT_WARN_UNUSED_RESULT;
/// Timestamp of when the <code>MessageCollection</code> for this channel has been created.
/// since:
/// 4.6.0
@property (nonatomic) int64_t messageCollectionLastAccessedAt;
/// Description
...
///
/// returns:
/// optional <code>Data</code> instance
- (NSData * _Nullable)serialize SWIFT_WARN_UNUSED_RESULT;
...
///
/// returns:
/// <code>true</code>, when this message is in feed channel.
- (BOOL)isFeedChannel SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 4.14.0
/// \param rating <code>Feedback/Rating</code> enum value.
///
/// \param comment Feedback string comment (optional).
///
/// \param completionHandler The handler block to be executed after the feedback is submitted.
///
- (void)submitFeedbackWithRating:(enum FeedbackRating)rating comment:(NSString * _Nullable)comment completionHandler:(void (^ _Nullable)(SBDFeedback * _Nullable, SBError * _Nullable))completionHandler;
...
/// \param comment Feedback string comment (optional).
///
/// \param completionHandler The handler block to be executed after the feedback is updated.
///
- (void)updateFeedbackWithRating:(enum FeedbackRating)rating comment:(NSString * _Nullable)comment completionHandler:(void (^ _Nullable)(SBDFeedback * _Nullable, SBError * _Nullable))completionHandler;
/// Delete feedback data.
/// since:
/// 4.14.0
/// \param completionHandler The handler block to be executed after the feedback is deleted.
///
- (void)deleteFeedbackWithCompletionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Submit data for a form type message.
/// A form type message contains <code>forms</code> fields in the message’s <code>extendedMessagePayload</code>.
/// The <code>BaseMessage/forms</code> property is the instance that contains the form information.
/// Using the given <code>Form</code> model,
/// You can create <code>formKey</code> and <code>answers</code> via <code>Form/formKey</code> and <code>Form/fields</code>.
/// since:
/// 4.12.0
/// \param formKey Specifies the <code>form_key</code> in <code>form</code> data.
///
/// \param answers The data type is <code>[String: String]</code>. The key should be the <code>key</code> of the <code>field</code>, and the value should be the <code>string</code> value to store.
///
/// \param completionHandler The handler block to be executed after the answer is submitted.
///
- (void)submitFormWithFormKey:(NSString * _Nonnull)formKey answers:(NSDictionary<NSString *, NSString *> * _Nonnull)answers completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.14.1.", "submitFormWithForm:completionHandler:");
/// Submit data for a form type message.
/// A form type message contains <code>forms</code> fields in the message’s <code>extendedMessagePayload</code>.
/// The <code>BaseMessage/forms</code> property is the instance that contains the form information.
/// Using the given <code>Form</code> model,
/// You can do that just by updating the <code>FormField/temporaryAnswer</code> property of each of the <code>fields</code>.
/// since:
/// 4.14.1
/// \param form A form instance with the answer to submit updated in <code>FormField/temporaryAnswer</code>.
///
/// \param completionHandler The handler block to be executed after the answer is submitted.
///
- (void)submitFormWithForm:(SBDForm * _Nonnull)form completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
@end
...
SWIFT_CLASS_NAMED("CachedBaseChannelInfo")
@interface SBDCachedBaseChannelInfo : NSObject
@property (nonatomic, readonly, strong) SBDBaseChannel * _Nonnull baseChannel;
@property (nonatomic, readonly) int64_t cachedMessageCount;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.6.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDCachedDataClearOrder, "CachedDataClearOrder", open) {
/// Messages will be deleted by the custom order.
/// SendbirdChatSDK will delete messages in the local storage depending the channel list that the client returns through the <code>ClearCachedDataByCustomOrderDelegate/sortByCustomOrder(allCachedBaseChannelInfos:)</code>.
/// since:
/// 4.6.0
  SBDCachedDataClearOrderCustom = 0,
/// Ascending order.
/// If the <code>BaseChannel/messageCollectionLastAccessedAt</code> is same, the <code>BaseMessage/createdAt</code> of <code>GroupChannel/lastMessage</code> will be used as the ascending order.
/// since:
/// 4.6.0
  SBDCachedDataClearOrderMessageCollectionAccessedAt = 1,
};
...
typedef SWIFT_ENUM_NAMED(NSInteger, SBChatError, "ChatError", open) {
  ...
  SBChatErrorExpiringSessionRequired = 400312,
  SBChatErrorAuthSessionNotAllowed = 400313,
  ...
  SBChatErrorStatUploadNotAllowed = 403200,
...
/// Group channel has been refreshed
  SBDCollectionEventSourceChannelRefresh = 7,
...
/// Feedback message
  SBDCollectionEventSourceEventFeedbackMessageUpdated = 135,
/// Notification Message Status
  SBDCollectionEventSourceEventNotificationMessageStatusUpdated = 136,
};
...
SWIFT_CLASS("_TtC15SendbirdChatSDK19DeliveryStatusEvent")
@interface DeliveryStatusEvent : NSObject
@property (nonatomic, readonly, copy) NSString * _Nullable channelUrl SWIFT_UNAVAILABLE_MSG("'channelUrl' has been renamed to 'channelURL'");
@property (nonatomic, copy) NSString * _Nullable channelURL;
...
@class SBDNotificationCategory;

/// A class that represents a feed channel.
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("FeedChannel")
@interface SBDFeedChannel : SBDBaseChannel
@property (nonatomic, copy) NSString * _Nonnull channelURL;
@property (nonatomic, copy) NSString * _Nonnull name;
...
@property (nonatomic) BOOL isDirty;
/// A bool value that represents whether the category filter feature is enabled for this channel.
/// The default value is <code>false</code>.
/// since:
/// 4.11.0
@property (nonatomic) BOOL isCategoryFilterEnabled;
/// A bool value that represents whether the template label feature is enabled for this channel.
/// The default value is <code>true</code>.
/// since:
/// 4.11.0
@property (nonatomic) BOOL isTemplateLabelEnabled;
/// The category list that can be used for this channel.
/// since:
/// 4.11.0
@property (nonatomic, copy) NSArray<SBDNotificationCategory *> * _Nonnull categories;
@end
...
/// since:
/// 4.6.0
+ (SBDFeedChannelListQuery * _Nonnull)createMyFeedChannelListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDFeedChannelListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// since:
/// 4.6.0
+ (SBDFeedChannelListQuery * _Nonnull)createMyFeedChannelListQueryWithParams:(SBDFeedChannelListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.6.0
+ (void)getChannelWithURL:(NSString * _Nonnull)url completionHandler:(void (^ _Nullable)(SBDFeedChannel * _Nullable, SBError * _Nullable))completionHandler;
@end


/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("FeedChannelChangeLogsParams")
@interface SBDFeedChannelChangeLogsParams : NSObject
...
/// since:
/// 3.1.0
SWIFT_CLASS_NAMED("FeedChannelContext")
@interface SBDFeedChannelContext : NSObject
/// Event source
@property (nonatomic) enum SBDCollectionEventSource source;
/// Checks whether the context is from an event or not.
///
...
/// since:
/// 4.6.0
SWIFT_PROTOCOL_NAMED("FeedChannelDelegate")
@protocol SBDFeedChannelDelegate <SBDBaseChannelDelegate>
@optional
- (void)feedChannelDidUpdateReadStatus:(SBDFeedChannel * _Nonnull)channel;
@end


SWIFT_CLASS_NAMED("FeedChannelListQuery")
@interface SBDFeedChannelListQuery : NSObject <NSCopying>
/// Boolean indicates there are more data to fetch
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
@property (nonatomic) NSUInteger limit;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use FeedChannel's `createMyFeedChannelListQuery`");
- (void)loadNextPageWithCompletionHandler:(void (^ _Nonnull)(NSArray<SBDFeedChannel *> * _Nullable, SBError * _Nullable))completionHandler;
@end
...
SWIFT_CLASS_NAMED("FeedChannelListQueryParams")
@interface SBDFeedChannelListQueryParams : NSObject
@property (nonatomic) BOOL includeEmptyChannel;
@property (nonatomic) NSUInteger limit;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDFeedChannelListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDFeedChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
/// since:
/// 4.14.0
SWIFT_CLASS_NAMED("Feedback")
@interface SBDFeedback : NSObject <NSCopying>
@property (nonatomic, readonly) int64_t id;
@property (nonatomic, readonly) enum FeedbackRating rating;
...
@interface SBDFeedback (SWIFT_EXTENSION(SendbirdChatSDK))
@end

/// The enum type to represent the status of the feedback.
/// since:
/// 4.14.0
typedef SWIFT_ENUM_NAMED(NSInteger, FeedbackStatus, "Status", open) {
  FeedbackStatusNotApplicable = 0,
  FeedbackStatusSubmitted = 1,
  FeedbackStatusNoFeedback = 2,
};
...
/// since:
/// 4.14.0
typedef SWIFT_ENUM_NAMED(NSInteger, FeedbackRating, "Rating", open) {
  FeedbackRatingGood = 0,
  FeedbackRatingBad = 1,
};
...
@property (nonatomic, readonly, copy) NSString * _Nullable plainUrl SWIFT_UNAVAILABLE_MSG("'plainUrl' has been renamed to 'plainURL'");
...
@property (nonatomic, readonly, strong) SBDMessageRequestState * _Nullable requestState SWIFT_UNAVAILABLE_MSG("This property has been removed.");
...
@class SBDFormField;
@class SBDFormFieldAnswer;

/// Form data
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("Form")
@interface SBDForm : NSObject <NSCopying>
/// Unique key of form.
@property (nonatomic, readonly, copy) NSString * _Nonnull formKey;
/// Indicates the input field data information array.
@property (nonatomic, readonly, copy) NSArray<SBDFormField *> * _Nonnull fields;
/// Indicates field data values that have been stored.
@property (nonatomic, readonly, copy) NSArray<SBDFormFieldAnswer *> * _Nullable answers;
/// constructor
- (nonnull instancetype)initWithFormKey:(NSString * _Nonnull)formKey fields:(NSArray<SBDFormField *> * _Nonnull)fields answers:(NSArray<SBDFormFieldAnswer *> * _Nullable)answers OBJC_DESIGNATED_INITIALIZER;
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
///
/// returns:
/// If <code>true</code>, can be submitted
/// NOTE: You <em>MUST</em> store the value entered by user interaction in the <code>FormField/temporaryAnswer</code>.
@property (nonatomic, readonly) BOOL canSubmit;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

enum SBDFormInputType : NSInteger;

/// Input field data information.
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("FormField")
@interface SBDFormField : NSObject <NSCopying>
/// Unique key of field
@property (nonatomic, readonly, copy) NSString * _Nonnull fieldKey;
/// Title
@property (nonatomic, readonly, copy) NSString * _Nonnull title;
/// Input type
@property (nonatomic, readonly, copy) NSString * _Nonnull inputTypeValue;
/// Indicate whether the field is required or not
@property (nonatomic, readonly) BOOL required;
/// Regular expressions for validation
@property (nonatomic, readonly, copy) NSString * _Nullable regex;
/// Placeholder
@property (nonatomic, readonly, copy) NSString * _Nullable placeholder;
/// Memory-cache reserved property for answer.
@property (nonatomic, copy) NSString * _Nullable temporaryAnswer;
/// constructor
- (nonnull instancetype)initWithFieldKey:(NSString * _Nonnull)fieldKey title:(NSString * _Nonnull)title inputTypeValue:(NSString * _Nonnull)inputTypeValue required:(BOOL)required regex:(NSString * _Nullable)regex placeholder:(NSString * _Nullable)placeholder OBJC_DESIGNATED_INITIALIZER;
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
/// returns:
/// <code>FormField</code> instance
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
/// Input type value
@property (nonatomic, readonly) enum SBDFormInputType inputType;
/// Returns whether it matches the regular expression.
@property (nonatomic, readonly) BOOL isValid;
/// Returns whether the field is in a submittable state
@property (nonatomic, readonly) BOOL isSubmittable;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface SBDFormField (SWIFT_EXTENSION(SendbirdChatSDK))
@end

/// The enum type to represent the input type of a feild key.
/// NOTE: The default value is ‘text’.
/// since:
/// 4.14.1
typedef SWIFT_ENUM_NAMED(NSInteger, SBDFormInputType, "InputType", open) {
  SBDFormInputTypeText = 0,
  SBDFormInputTypePhone = 1,
  SBDFormInputTypeEmail = 2,
  SBDFormInputTypePassword = 3,
};
...
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("FormFieldAnswer")
@interface SBDFormFieldAnswer : NSObject
- (nonnull instancetype)initWithFieldKey:(NSString * _Nonnull)fieldKey value:(NSString * _Nonnull)value OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("GlobalNotificationChannelSetting")
@interface SBDGlobalNotificationChannelSetting : NSObject
...
/// since:
/// 4.6.0
@property (nonatomic) BOOL isChatNotification;
...
/// note:
/// Only copies the message whose <code>BaseMessage/sendingStatus</code> is <code>MessageSendingStatus/succeeded</code>
/// since:
/// 4.10.0
/// \param message <code>MultipleFilesMessage</code> object.
///
/// \param targetChannel <code>GroupChannel</code> object that wants to copy the <code>message</code>.
///
/// \param completionHandler The handler block to execute when the copying is completed.
///
///
/// returns:
/// The temporary <code>MultipleFilesMessage</code> object that contains a <em>request ID</em> instead of a message ID. If there’s any error, <code>nil</code> could be returned.
- (SBDMultipleFilesMessage * _Nullable)copyMultipleFilesMessageWithMessage:(SBDMultipleFilesMessage * _Nonnull)message toTargetChannel:(SBDGroupChannel * _Nonnull)targetChannel completionHandler:(void (^ _Nullable)(SBDMultipleFilesMessage * _Nullable, SBError * _Nullable))completionHandler;
/// Attempts to resend a failed mutiple files message.
/// note:
/// Only resends the message that its <code>BaseMessage/sendingStatus</code> is <code>MessageSendingStatus/failed</code>
/// since:
/// 4.10.0
/// \param message <code>MultipleFilesMessage</code> object to resend.
///
/// \param fileUploadHandler A handler block to execute after each file is uploaded. This block takes four arguments: the <em>requestId</em> of a file,  the <em>index</em> of a file, <code>UploadableFileInfo</code> object, and the <em>error</em>
///
/// \param completionHandler The handler block to execute when the copying is completed.
///
/// \param completionHandler The handler block to excute when the sending is completed. When the sending is failed, the parameter represents the failed message.
///
///
/// returns:
/// A temporary <code>MultipleFilesMessage</code> object being sent to the Sendbird server.
- (SBDMultipleFilesMessage * _Nullable)resendMultipleFilesMessageWithMessage:(SBDMultipleFilesMessage * _Nonnull)message fileUploadHandler:(void (^ _Nullable)(NSString * _Nonnull, NSInteger, SBDUploadableFileInfo * _Nonnull, SBError * _Nullable))fileUploadHandler completionHandler:(void (^ _Nullable)(SBDMultipleFilesMessage * _Nullable, SBError * _Nullable))completionHandler;
@end
...
@class SBDPinnedMessageListQuery;
@class SBDPinnedMessageListQueryParams;
...
/// Creates a <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages in the group channel.
/// since:
/// 4.8.0
///
/// returns:
/// A <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages.
- (SBDPinnedMessageListQuery * _Nullable)createPinnedMessageListQuery SWIFT_WARN_UNUSED_RESULT;
/// Creates a <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages in the group channel.
/// since:
/// 4.8.0
/// \param paramsBuilder The builder closure for setting <code>PinnedMessageListQueryParams</code>.
///
///
/// returns:
/// A <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages.
- (SBDPinnedMessageListQuery * _Nullable)createPinnedMessageListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPinnedMessageListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages in the group channel.
/// since:
/// 4.8.0
/// \param params A <code>PinnedMessageListQueryParams</code> object containing the parameters for the query.
///
///
/// returns:
/// A <code>PinnedMessageListQuery</code> object that can be used to retrieve a list of pinned messages.
- (SBDPinnedMessageListQuery * _Nullable)createPinnedMessageListQueryWithParams:(SBDPinnedMessageListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.6.0
@property (nonatomic) BOOL includeChatNotification;
...
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)newMessage;
/// Invoked when sending message or resending message is failed.
/// \param channel The channel that has the failed message. 
///
/// \param failed Failed message object. 
///
...
/// \param channel The channel that has the message. 
///
/// \param canceled Canceled message object. 
///
...
/// \param channel The channel that has the message. 
///
/// \param pending Pending message object. 
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel pending:(SBDBaseMessage * _Nonnull)pending;
/// Invoked when receiving the self-voted vote event.
- (void)channel:(SBDBaseChannel * _Nonnull)channel selfVotedEvent:(SBDPollVoteEvent * _Nonnull)selfVotedEvent;
/// Invoked when the messages’ status has been changed.
/// since:
/// 4.13.0
/// \param channel The channel that has the messages.
///
/// \param messageIds The ID of the messages that their message status should be updated.
///
/// \param newMessageStatus New message status.
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel messageIds:(NSArray<NSNumber *> * _Nonnull)messageIds newMessageStatus:(enum SBDNotificationMessageStatus)newMessageStatus;
/// Invoked when the messages’ status has been changed.
/// since:
/// 4.13.0
/// \param channel The channel that has the messages.
///
/// \param oldMessageStatus Old message status.
///
/// \param newMessageStatus New message status.
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel oldMessageStatus:(enum SBDNotificationMessageStatus)oldMessageStatus newMessageStatus:(enum SBDNotificationMessageStatus)newMessageStatus;
/// Invoked when feedback messages are submit, updated or deleted.
/// since:
/// 4.14.0
...
///
- (void)channel:(SBDGroupChannel * _Nonnull)channel didUpdateFeedbackMessage:(SBDBaseMessage * _Nonnull)didUpdateFeedbackMessage;
@end
...
/// \param channel The channel that has the message thread.
///
/// \param pollId just removed poll id
///
...
/// 3.0.90
@property (nonatomic) BOOL isEphemeral;
@property (nonatomic, readonly) BOOL discoverable SWIFT_UNAVAILABLE_MSG("'discoverable' has been renamed to 'isDiscoverable'");
...
/// 3.0.136
@property (nonatomic) BOOL isDiscoverable;
@property (nonatomic, readonly) BOOL strict SWIFT_UNAVAILABLE_MSG("'strict' has been renamed to 'isStrict'");
...
- (enum NSComparisonResult (^ _Nonnull)(id _Nullable, id _Nullable))comparator SWIFT_WARN_UNUSED_RESULT;
/// Compares two channels
/// \param obj1 First channel
///
/// \param obj2 Second channel
///
///
/// returns:
/// <code>ComparisonResult</code> value
- (enum NSComparisonResult)orderBetweenObjectWithObj1:(id _Nullable)obj1 obj2:(id _Nullable)obj2 SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.11.0
@property (nonatomic) int64_t createdBefore;
/// Searches for group channels created after the specified value. (milliseconds)
/// since:
/// 4.11.0
@property (nonatomic) int64_t createdAfter;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Initializes and returns a newly allocated params object that mutated through builder closure.
/// \param builder The builder closure.
...
/// since:
/// 4.6.0
@property (nonatomic, strong) SBDLocalCacheConfig * _Nullable localCacheConfig;
...
///     <ul>
///       <li>
///         <code>true</code>: When SendbirdChat is initialized, the work thread will be handled synchronously until the localCaching migration is complete.
///       </li>
///       <li>
///         <code>false</code>: Local caching migration operations are handled asynchronously.
///       </li>
///     </ul>
///   </li>
///   <li>
///     And, if the <code>isLocalCachingEnabled</code>  is <code>false</code>, no localCaching migration operation is performed even if this value is <code>true</code>.
///   </li>
/// </ul>
@property (nonatomic) BOOL needsSynchronous;
...
///
- (nonnull instancetype)initWithApplicationId:(NSString * _Nonnull)applicationId isLocalCachingEnabled:(BOOL)isLocalCachingEnabled localCacheConfig:(SBDLocalCacheConfig * _Nullable)localCacheConfig logLevel:(enum SBDLogLevel)logLevel appVersion:(NSString * _Nullable)appVersion OBJC_DESIGNATED_INITIALIZER;
/// Parameter constructor
/// since:
/// 4.15.0
/// \param applicationId Sendbird Application ID
...
/// \param appVersion host app version
///
/// \param needsSynchronous If this value set <code>true</code>, when SendbirdChat is initialized, the work thread will be handled synchronously until the localCaching migration is complete.
///
- (nonnull instancetype)initWithApplicationId:(NSString * _Nonnull)applicationId isLocalCachingEnabled:(BOOL)isLocalCachingEnabled localCacheConfig:(SBDLocalCacheConfig * _Nullable)localCacheConfig logLevel:(enum SBDLogLevel)logLevel appVersion:(NSString * _Nullable)appVersion needsSynchronous:(BOOL)needsSynchronous OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.15.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDInitializationState, "InitializationState", open) {
  SBDInitializationStateNotStarted = 0,
  SBDInitializationStateInitializing = 1,
  SBDInitializationStateMigrating = 2,
  SBDInitializationStateCompleted = 3,
};



SWIFT_PROTOCOL_NAMED("InternalConnectionDelegate")
@protocol SBDInternalConnectionDelegate
...
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("LocalCacheConfig")
@interface SBDLocalCacheConfig : NSObject
/// The max size of the database in megabyte.
/// The minimum value is 64MB.
/// since:
/// 4.6.0
...
/// since:
/// 4.6.0
@property (nonatomic) enum SBDCachedDataClearOrder clearOrder;
...
@property (nonatomic, copy) enum NSComparisonResult (^ _Nullable customClearOrderComparator)(SBDCachedBaseChannelInfo * _Nonnull, SBDCachedBaseChannelInfo * _Nonnull);
/// Determines whether encryption is turned on when using Local Caching.
/// If set to true, files are protected at <code>CompleteUnlessOpen</code> level.
/// Default is false, which protects files at <code>CompleteUntilFirstUserAuthentication</code> level.
/// since:
/// 4.6.0
@property (nonatomic) BOOL isEncryptionEnabled;
/// Option to enable auto resending of messages that have failed due to network reasons.
/// If set to true, when the network connection is reconnected, the SDK will internally try to resend messages.
/// since:
/// 4.11.0
@property (nonatomic) BOOL enableAutoResend;
- (nonnull instancetype)initWithIsEncryptionEnabled:(BOOL)isEncryptionEnabled;
- (nonnull instancetype)initWithIsEncryptionEnabled:(BOOL)isEncryptionEnabled enableAutoResend:(BOOL)enableAutoResend OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSString * _Nullable profileUrl SWIFT_UNAVAILABLE_MSG("'profileUrl' has been renamed to 'profileURL'");
/// Profile image url.
@property (nonatomic, readonly, copy) NSString * _Nullable profileURL;
@property (nonatomic, readonly, copy) NSString * _Nullable originalProfileUrl SWIFT_UNAVAILABLE_MSG("'originalProfileUrl' has been renamed to 'originalProfileURL'");
/// Original profile image url.
@property (nonatomic, readonly, copy) NSString * _Nullable originalProfileURL;
@property (nonatomic, readonly, copy) NSString * _Nullable plainProfileImageUrl SWIFT_UNAVAILABLE_MSG("'plainProfileImageUrl' has been renamed to 'plainProfileImageURL'");
...
SWIFT_CLASS("_TtC15SendbirdChatSDK23MembersChangeLogsResult")
@interface MembersChangeLogsResult : NSObject
/// Indicates List of changed members.
@property (nonatomic, readonly, copy) NSArray<SBDUser *> * _Nonnull userList;
/// Remaining time in milliseconds until the next request can be made.
/// If this value is non-null,
/// it means the next request should be made after this time interval or the result will be empty.
@property (nonatomic, readonly) int64_t remainingTimeUntilNextRequest;
...
/// An object that represents the information about messageEventes of message, whose properties show how many
/// since:
/// 4.15.3
SWIFT_CLASS("_TtC15SendbirdChatSDK13MessageEvents")
@interface MessageEvents : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
enum SBDMessageReviewStatus : NSInteger;
@class SBDOriginalMessageInfo;

/// An object that represents the information about message review history
/// since:
/// 4.12.0
SWIFT_CLASS_NAMED("MessageReviewInfo")
@interface SBDMessageReviewInfo : NSObject
/// The review status information for messages that are changed via the rule engine. default is <code>.none</code>
@property (nonatomic, readonly) enum SBDMessageReviewStatus status;
/// An object that represents the information about original message
@property (nonatomic, readonly, strong) SBDOriginalMessageInfo * _Nullable originalMessageInfo;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.12.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDMessageReviewStatus, "MessageReviewStatus", open) {
  SBDMessageReviewStatusNone = 0,
  SBDMessageReviewStatusInReview = 1,
  SBDMessageReviewStatusApproved = 2,
};
...
/// since:
/// 4.11.0
SWIFT_CLASS_NAMED("NotificationCategory")
@interface SBDNotificationCategory : NSObject
...
@protocol SBDNotificationCollectionDelegate;
enum SBDNotificationCollectionInitPolicy : NSInteger;

/// An object that accesses the cache for the messages.
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("NotificationCollection")
@interface SBDNotificationCollection : SBDBaseCollection
/// Notification collection delegate.
@property (nonatomic, weak) id <SBDNotificationCollectionDelegate> _Nullable delegate;
@property (nonatomic) int64_t startingPoint;
/// If <code>true</code>, there may be the messages on the next page.
@property (nonatomic) BOOL hasNext;
/// If <code>true</code>, there may be the messages on the previous page.
...
/// The <code>messages</code> is the messages that are loaded from the server. The <code>error</code> will be returned when the loading message failed.
///
- (void)startCollectionWithInitPolicy:(enum SBDNotificationCollectionInitPolicy)initPolicy cacheResultHandler:(void (^ _Nullable)(NSArray<SBDBaseMessage *> * _Nullable, SBError * _Nullable))cacheResultHandler apiResultHandler:(void (^ _Nullable)(NSArray<SBDBaseMessage *> * _Nullable, SBError * _Nullable))apiResultHandler;
/// Invalidates the object.
- (void)dispose;
/// Loads messages of the next page.
/// \param completionHandler The callback to call when the load is complete. The <code>error</code> will be
...
@interface SBDNotificationCollection (SWIFT_EXTENSION(SendbirdChatSDK))
...
@interface SBDNotificationCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDInternalConnectionDelegate>
- (void)didInternalDisconnect;
- (void)didExternalDisconnect;
@end


@interface SBDNotificationCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <InternalChannelEventDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel messageIds:(NSArray<NSNumber *> * _Nonnull)messageIds newMessageStatus:(enum SBDNotificationMessageStatus)newMessageStatus;
- (void)channel:(SBDBaseChannel * _Nonnull)channel oldMessageStatus:(enum SBDNotificationMessageStatus)oldMessageStatus newMessageStatus:(enum SBDNotificationMessageStatus)newMessageStatus;
@end


@interface SBDNotificationCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDConnectionDelegate>
- (void)didSucceedReconnection;
- (void)didConnectWithUserId:(NSString * _Nonnull)userId;
@end
...
@interface SBDNotificationCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDFeedChannelDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel didReceiveMessage:(SBDBaseMessage * _Nonnull)message;
- (void)channel:(SBDBaseChannel * _Nonnull)channel didUpdateMessage:(SBDBaseMessage * _Nonnull)message;
- (void)channel:(SBDBaseChannel * _Nonnull)channel messageWasDeleted:(int64_t)messageId;
- (void)channel:(SBDBaseChannel * _Nonnull)channel updatedReaction:(SBDReactionEvent * _Nonnull)reactionEvent;
...
@class SBDNotificationContext;

/// Methods that are invoked when the event of the message collection occurs.
/// since:
/// 4.6.0
SWIFT_PROTOCOL_NAMED("NotificationCollectionDelegate")
@protocol SBDNotificationCollectionDelegate
@optional
/// Invoked when the messages are added.
/// \param collection Message collection object.
...
/// \param addedMessages Messages to be added.
///
- (void)notificationCollection:(SBDNotificationCollection * _Nonnull)collection context:(SBDNotificationContext * _Nonnull)context channel:(SBDFeedChannel * _Nonnull)channel addedMessages:(NSArray<SBDBaseMessage *> * _Nonnull)addedMessages;
/// Invoked when the message are updated.
/// \param collection Message collection object.
///
/// \param context The reason why the messages are updated.
...
/// \param updatedMessages Messages to be updated.
///
- (void)notificationCollection:(SBDNotificationCollection * _Nonnull)collection context:(SBDNotificationContext * _Nonnull)context channel:(SBDFeedChannel * _Nonnull)channel updatedMessages:(NSArray<SBDBaseMessage *> * _Nonnull)updatedMessages;
/// Invoked when the message are deleted.
/// \param collection Message collection object.
///
/// \param context The reason why the messages are deleted.
...
/// \param deletedMessages Messages to be deleted.
///
- (void)notificationCollection:(SBDNotificationCollection * _Nonnull)collection context:(SBDNotificationContext * _Nonnull)context channel:(SBDFeedChannel * _Nonnull)channel deletedMessages:(NSArray<SBDBaseMessage *> * _Nonnull)deletedMessages;
/// Invoked when the channel that has the message collection is changed.
/// \param collection Message collection object.
///
/// \param context The reason why the channel are changed.
...
/// \param updatedChannel The channel that has the message collection has.
///
- (void)notificationCollection:(SBDNotificationCollection * _Nonnull)collection context:(SBDFeedChannelContext * _Nonnull)context updatedChannel:(SBDFeedChannel * _Nonnull)updatedChannel;
/// Invoked when the channel that has the message collection is deleted.
/// \param collection Message collection object.
///
/// \param context The reason why the channel are deleted.
...
/// \param channelURL Channel URL that has been deleted.
///
- (void)notificationCollection:(SBDNotificationCollection * _Nonnull)collection context:(SBDFeedChannelContext * _Nonnull)context deletedChannel:(NSString * _Nonnull)channelURL;
/// Invoked when the huge gap has been detected.
/// \param collection Message collection object.
///
- (void)didDetectHugeGap:(SBDNotificationCollection * _Nonnull)collection;
@end

/// The policy for the message collection initialization.
/// since:
/// 4.6.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDNotificationCollectionInitPolicy, "NotificationCollectionInitPolicy", open) {
/// Caches will be replaced by api result
  SBDNotificationCollectionInitPolicyCacheAndReplaceByApi = 0,
};
...
@interface SBDNotificationContext : NSObject
/// Event source
@property (nonatomic, readonly) enum SBDCollectionEventSource source;
/// Checks whether the context is from an event or not.
///
...
@interface SBDNotificationData : NSObject
@property (nonatomic, copy) NSString * _Nonnull label;
@property (nonatomic, copy) NSString * _Nonnull templateKey;
@property (nonatomic, copy) NSArray<NSString *> * _Nullable tags;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull templateVariables;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SBDNotificationInfo : NSObject
@property (nonatomic) BOOL isEnabled;
@property (nonatomic, copy) NSString * _Nonnull templateListToken;
@property (nonatomic) int64_t settingsUpdatedAt;
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nonnull feedChannels;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.13.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDNotificationMessageStatus, "NotificationMessageStatus", open) {
  SBDNotificationMessageStatusNone = 0,
  SBDNotificationMessageStatusSent = 1,
  SBDNotificationMessageStatusRead = 2,
};

/// Priority of the notification message
/// since:
/// 4.16.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDNotificationPriority, "NotificationPriority", open) {
  SBDNotificationPriorityHigh = 0,
  SBDNotificationPriorityNormal = 100,
  SBDNotificationPriorityLow = 200,
};


/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("NotificationTemplate")
@interface SBDNotificationTemplate : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull jsonPayload;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("NotificationTemplateList")
@interface SBDNotificationTemplateList : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull jsonPayload;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("NotificationTemplateListParams")
@interface SBDNotificationTemplateListParams : NSObject
@property (nonatomic) BOOL reverse;
@property (nonatomic, copy) NSArray<NSString *> * _Nullable keys;
@property (nonatomic) NSInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDNotificationTemplateListParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDNotificationTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDNotificationTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param event event object contains updated poll information.
///
- (void)channel:(SBDOpenChannel * _Nonnull)channel didUpdatePoll:(SBDPollUpdateEvent * _Nonnull)event;
/// A callback when vote has been occurred.
/// since:
/// 4.5.0
/// \param channel The channel that has the message thread.
...
/// \param event event object that contains voting information.
///
- (void)channel:(SBDOpenChannel * _Nonnull)channel didVotePoll:(SBDPollVoteEvent * _Nonnull)event;
/// A callback when vote has been deleted.
/// since:
/// 4.5.0
/// \param channel The channel that has the message thread.
...
/// \param pollId just removed poll id
///
- (void)channel:(SBDOpenChannel * _Nonnull)channel pollWasDeleted:(int64_t)pollId;
@end
...
/// since:
/// 4.12.0
SWIFT_CLASS_NAMED("OriginalMessageInfo")
@interface SBDOriginalMessageInfo : NSObject
/// Original message generation createdAt ts for in_review status
@property (nonatomic, readonly) int64_t createdAt;
/// Original message ID for in_review status
@property (nonatomic, readonly) int64_t messageId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS_NAMED("PinnedMessage")
@interface SBDPinnedMessage : NSObject <NSCopying>
...
/// This class provides a way to retrieve a list of pinned messages in a group channel.
/// It has properties to get the query options and to check the status of the query.
/// since:
/// 4.8.0
SWIFT_CLASS_NAMED("PinnedMessageListQuery")
@interface SBDPinnedMessageListQuery : NSObject
...
/// since:
/// 4.8.0
SWIFT_CLASS_NAMED("PinnedMessageListQueryParams")
@interface SBDPinnedMessageListQueryParams : NSObject <NSCopying>
/// The number of <code>BaseMessage</code>s per queried page. Default is <code>50</code>.
/// since:
/// 4.8.0
@property (nonatomic) NSInteger limit;
/// A boolean flag that determines whether or not to include a meta array in the message.
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPinnedMessageListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
/// returns:
/// <code>PinnedMessageListQueryParams</code> instance
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC15SendbirdChatSDK15ReadStatusEvent")
@interface ReadStatusEvent : NSObject
/// User
...
/// since:
/// 4.7.0
@property (nonatomic, readonly) int64_t remainingDuration;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Gets the initialized state without the warning message printed out.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isInitializedWithoutWarning;)
+ (BOOL)isInitializedWithoutWarning SWIFT_WARN_UNUSED_RESULT;
...
+ (SBError * _Nullable)initializeSynchronouslyWithParams:(SBDInitParams * _Nonnull)params SWIFT_DEPRECATED_MSG("This method is deprecated in 4.15.0. Set `needsSynchronous` in `InitParams` to `true` and use `initialize(params:migrationStartHandler:completionHandler:)` instead.", "initializeWithParams:migrationStartHandler:completionHandler:");
...
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird notification’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
/// Use the <code>disconnect(completionHandler:)</code> method to deauthenticate.
/// since:
/// 4.10.0
/// \param userId The user ID.
///
...
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateFeedWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler;
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird notification’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
/// Use the <code>disconnect(completionHandler:)</code> method to deauthenticate.
/// since:
...
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateFeedWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken apiHost:(NSString * _Nullable)apiHost completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler;
...
/// \param completionHandler The handler block to execute.
///
+ (void)disconnectWebSocketWithCompletionHandler:(void (^ _Nullable)(void))completionHandler;
...
/// since:
/// 4.0.0
/// \param builder The builder closure for setting <code>MessageSearchQueryParams</code>
///
///
/// returns:
...
/// \param completionHandler The handler block to execute.
///
+ (void)unregisterPushToken:(NSData * _Nonnull)devToken completionHandler:(void (^ _Nullable)(NSDictionary * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.2.4. Please use `unregisterPushToken(_ pushToken: Data, completionHandler: SBErrorHandler?)`");
/// Unregisters the current device token from Sendbird.
/// \param pushToken Device token for APNS.
///
/// \param completionHandler The handler block to execute.
///
+ (void)unregisterPushToken:(NSData * _Nonnull)pushToken completion:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Unregisters all device tokens for the current user from Sendbird.
/// \param completionHandler The handler block to execute.
///
+ (void)unregisterAllPushTokenWithCompletionHandler:(void (^ _Nullable)(NSDictionary * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.2.4. Please use `unregisterAllPushToken(completionHandler: SBErrorHandler?)`");
/// Unregisters all device tokens for the current user from Sendbird.
/// \param completionHandler The handler block to execute.
///
+ (void)unregisterAllPushTokenWithCompletion:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
///
+ (void)getTotalUnreadMessageCountWithParams:(SBDGroupChannelTotalUnreadMessageCountParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSUInteger, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.6.0.", "getTotalUnreadMessageCountWithFeedWithParams:completionHandler:");
/// Gets the total unread message count of the channels with filters of params.
/// since:
/// 4.6.0
/// \param params The instance of parameters to filter.
...
/// and the other is error.
///
+ (void)getTotalUnreadMessageCountWithFeedWithParams:(SBDGroupChannelTotalUnreadMessageCountParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSUInteger, NSUInteger, SBError * _Nullable))completionHandler;
...
/// \param completionHandler The handler block to execute
///
+ (void)markPushNotificationAsDeliveredWithRemoteNotificationPayload:(NSDictionary * _Nonnull)remoteNotificationPayload completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
/// \param token The token used to get next pagination of changelogs.
///
/// \param completionHandler The handler type of <code>MembersChangeLogsHandler</code> block to execute.
///
+ (void)getMembersChangeLogsWithToken:(NSString * _Nonnull)token completionHandler:(void (^ _Nonnull)(MembersChangeLogsResult * _Nullable, SBError * _Nullable))completionHandler;
...
/// \param completionHandler The handler type of <code>MembersChangeLogsHandler</code> block to execute.
///
+ (void)getMembersChangeLogsWithTimestamp:(int64_t)timestamp completionHandler:(void (^ _Nonnull)(MembersChangeLogsResult * _Nullable, SBError * _Nullable))completionHandler;
...
/// important:
/// This function <em>must</em> be used after the initialize function of SendbirdChat.
...
/// since:
/// 4.6.0
+ (SBDNotificationCollection * _Nullable)createNotificationCollectionWithChannel:(SBDFeedChannel * _Nonnull)channel startingPoint:(int64_t)startingPoint params:(SBDMessageListParams * _Nonnull)params delegate:(id <SBDNotificationCollectionDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 4.1.0
/// \param paramsBuilder The builder closure for setting <code>PollListQueryParams</code>.
///
///
/// returns:
/// <code>PollListQuery</code> instance.
...
/// \param timestamp The number of milli-seconds(msec). Requests changelogs from that time. This value must not be negative.
///
/// \param params the parameter object that filters a result. See <code>FeedChannelChangeLogsParams</code> for more detail
///
/// \param completionHandler The handler type of <code>FeedChannelChangeLogsHandler</code> block to
/// execute. The <code>updatedChannels</code> is the channels that were updated. The <code>deletedChannelURLs</code>
/// is the list of the deleted channel URLs. If there are more changelogs that are not returned yet, the
/// <code>hasMore</code> is <code>true</code>. The <code>token</code> can be used to get more changedlogs.
///
+ (void)getMyFeedChannelChangeLogsWithTimestamp:(int64_t)timestamp params:(SBDFeedChannelChangeLogsParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSArray<SBDFeedChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
...
/// <code>hasMore</code> is <code>true</code>. The <code>token</code> can be used to get more changedlogs.
///
+ (void)getMyFeedChannelChangeLogsByTokenWithToken:(NSString * _Nullable)token params:(SBDFeedChannelChangeLogsParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSArray<SBDFeedChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// since:
/// 4.6.0
+ (SBDUnreadMessageCount * _Nonnull)getUnreadMessageCount SWIFT_WARN_UNUSED_RESULT;
/// since:
/// 4.6.0
+ (void)getGlobalNotificationChannelSettingWithCompletionHandler:(void (^ _Nonnull)(SBDGlobalNotificationChannelSetting * _Nullable, SBError * _Nullable))completionHandler;
/// since:
/// 4.6.0
+ (void)getNotificationTemplateListWithToken:(NSString * _Nullable)token params:(SBDNotificationTemplateListParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(SBDNotificationTemplateList * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// since:
/// 4.6.0
+ (void)getNotificationTemplateWithKey:(NSString * _Nonnull)key completionHandler:(void (^ _Nonnull)(SBDNotificationTemplate * _Nullable, SBError * _Nullable))completionHandler;
...
/// note:
/// This method just sends the message through API. In most scenarios, you should call <code>GroupChannel.getChannel</code> or <code>OpenChannel.getChannel</code> and use the retrieved channel objects to send and receive messages. This method is for sending message without getting the channel object when the application execution time is limited, such as in app extensions.
/// \param channelType The channel type of the channel to send the message in.
///
/// \param channelURL The channel URL of the channel to send the message in.
///
/// \param params The instance of <code>UserMessageCreateParams</code> that can has parameters
/// related with string message.
///
...
/// error made when there is something wrong to message.
///
+ (void)sendUserMessageWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL params:(SBDUserMessageCreateParams * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDUserMessage * _Nullable, SBError * _Nullable))completionHandler;
@end
...
/// since:
/// 4.6.0
SWIFT_CLASS_NAMED("UnreadMessageCount")
@interface SBDUnreadMessageCount : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
- (void)didUpdateTotalUnreadMessageCount:(int32_t)totalCount totalCountByCustomType:(NSDictionary<NSString *, NSNumber *> * _Nullable)totalCountByCustomType SWIFT_DEPRECATED_MSG("This method is deprecated in 4.6.0.", "didUpdateTotalUnreadMessageCountWithUnreadMessageCount:");
/// since:
/// 4.6.0
- (void)didUpdateTotalUnreadMessageCountWithUnreadMessageCount:(SBDUnreadMessageCount * _Nonnull)unreadMessageCount;
@end
...
/// since:
/// 4.12.0
@property (nonatomic, strong) SBDMessageReviewInfo * _Nullable messageReviewInfo;
...
@property (nonatomic, readonly, copy) NSString * _Nullable profileImageUrl SWIFT_UNAVAILABLE_MSG("'profileImageUrl' has been renamed to 'profileImageURL'");
